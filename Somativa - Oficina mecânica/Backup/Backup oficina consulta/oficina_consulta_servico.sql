...
CREATE TABLE `servico` (
  ...
  `preco_servico` decimal(8,2) DEFAULT NULL,
...
INSERT  IGNORE INTO `servico` VALUES (1,150.00,'Troca de óleo'),(2,200.00,'Revisão completa'),(3,100.00,'Alinhamento e balanceamento'),(4,250.00,'Troca de freios'),(5,300.00,'Troca de embreagem');
