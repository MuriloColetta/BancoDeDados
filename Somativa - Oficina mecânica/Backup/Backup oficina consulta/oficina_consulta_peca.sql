...
CREATE TABLE `peca` (
  ...
  `descricao_peca` varchar(255) DEFAULT NULL,
...
INSERT  IGNORE INTO `peca` VALUES (1,'Filtro de Óleo','Filtro para motor 1.0 a 2.0',225.00,250.00,50),(2,'Pastilha de Freio','Pastilha dianteira',60.00,120.00,30),(3,'Correia Dentada','Correia para motores 1.6',45.00,90.00,20),(4,'Amortecedor','Amortecedor dianteiro',150.00,250.00,15),(5,'Velas de Ignição','Jogo com 4 velas',30.00,60.00,100);
