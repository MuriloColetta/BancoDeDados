...
CREATE TABLE `os_pecas` (
  ...
  `preco_unitario_cobrado` decimal(8,2) DEFAULT NULL,
  PRIMARY KEY (`id_os`,`id_peca`),
  KEY `id_peca` (`id_peca`),
  CONSTRAINT `os_pecas_ibfk_1` FOREIGN KEY (`id_os`) REFERENCES `os` (`id_os`),
...
INSERT  IGNORE INTO `os_pecas` VALUES (1,1,2,40.00),(2,2,1,120.00),(3,3,1,90.00),(4,4,3,250.00),(5,5,1,60.00);
