...
CREATE TABLE `possui` (
  ...
  KEY `id_peca` (`id_peca`),
  CONSTRAINT `possui_ibfk_1` FOREIGN KEY (`id_estoque`) REFERENCES `estoque` (`id_estoque`),
  CONSTRAINT `possui_ibfk_2` FOREIGN KEY (`id_peca`) REFERENCES `peca` (`id_peca`)
...
-- Dump completed on 2025-12-01 14:03:51
