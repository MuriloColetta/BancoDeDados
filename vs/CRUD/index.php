<?php
// conexão com o BD
$mysqli = mysqli_connect('localhost', 'root', 'senaisp', 'Biblioteca');

// buscar valores no BD
$columns = array('nome','email','data_nascimento');
...
if ($result = $mysqli->query('SELECT * FROM usuario ORDER BY ' .  $column . ' ' . $sort_order)) {
		...
		<body>
			<table>
				<tr>
					...
					<th><a href="index.php?column=data_nascimento&order=<?php echo $asc_or_desc; ?>">Data de nascimento<i class="fas fa-sort<?php echo $column == 'data_nascimento' ? '-' . $up_or_down : ''; ?>"></i></a></th>
				</tr>
